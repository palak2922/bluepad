...
class _LoginState extends State<Login> {
  ...
  List<String> text = [
    'The true essence of life is art. One which has been enjoyed through millions of years through multiple cultures and artforms. From the early caveman paintings to the latest TikTok. All of them can be considered a form of art. Art is subjective. Art is supposed to evoke emotions and make the observer feel life as it happens.',
  ];
